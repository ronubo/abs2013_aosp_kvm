...
PRODUCT_PACKAGES +=
PRODUCT_COPY_FILES +=
PRODUCT_NAME := abs2013_aosp_kvm # This must be equal to the  Makefile prefix defined in AndroidProducts
PRODUCT_DEVICE := aosp_kvm
PRODUCT_MODEL := AOSP KVM build for ABS2013
...
PRODUCT_COPY_FILES += \
        ...
        device/nubo/aosp_kvm/init.abs2013_aosp_kvm.sh:system/etc/init.abs2013_aosp_kvm.sh \
